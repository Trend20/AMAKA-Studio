    ...
    return (
        <div className="relative flex items-center">
            ...
            <div
                ...
                className={`absolute right-0 top-6.5 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${
            ...
            >
                <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                    <li>
                        <Link
                            href="/profile"
                            className="flex items-center gap-3.5 text-sm font-light duration-300 ease-in-out hover:text-primary lg:text-base"
                        >
                            <svg
                ...
                <button className="flex items-center gap-3.5 py-4 px-6 text-sm font-light duration-300 ease-in-out hover:text-primary lg:text-base">
                    <svg
                        className="fill-current"
                        width="22"
                        height="22"
