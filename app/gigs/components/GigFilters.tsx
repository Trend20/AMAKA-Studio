const GigFilters = () =>{
    return(
        <div className="flex py-5 border-b w-full flex-wrap gap-2.5 lg:items-center items-start border-stroke lg:space-x-5 space-x-3 lg:px-8 px-4 ml-3">
                <select name="amout" id="amount" className="flex rounded-full outline-0 py-2 px-4 bg-transparent border border-stroke w-40">
                ...
                <select name="amout" id="amount" className="flex rounded-full bg-transparent outline-0 py-2 px-4 border border-stroke">
                ...
                <select name="amout" id="amount" className="flex rounded-full bg-transparent outline-0 px-4 py-2 border border-stroke">
